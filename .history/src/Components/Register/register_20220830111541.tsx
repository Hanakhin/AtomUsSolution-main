    ...
    return (
        <Container>
            <RegisterForm>
                ...
                <RegisterInput placeholder="Email@email.com" required type='email' name='email' ref={email} onChange={(event) => { setForm({ ...form, email: event.currentTarget.value }) }}></RegisterInput>
