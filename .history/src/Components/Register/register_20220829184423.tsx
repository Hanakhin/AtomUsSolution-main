...
export const Register: React.FC = (props) => {
 ...
 api.get(apiUrl).then(res=>{
    ...
    const test = () => {
        ...
        api.get(apiUrl).then(res=>{
            const userToVerify = res.data
            const nameToVerify = res.data[0].username
            const nameEntered = user.username
            if(nameEntered == nameToVerify){
